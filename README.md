...
The app was is at the moment made for our school ground floor. (Specific labelmap and neural network as well as a xml map using androidstudio layout) However, it can be adapted to other places. To do that, check out in CustomizingILBOD.txt what is needed to be change.
